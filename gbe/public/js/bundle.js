...
var _SimpleCard = require('./components/SimpleCard');

var _SimpleCard2 = _interopRequireWildcard(_SimpleCard);

var _TaskApp = require('./components/TaskApp');

var _TaskApp2 = _interopRequireWildcard(_TaskApp);

var componentsMap = {};
componentsMap.SimpleCard = _SimpleCard2['default'];
componentsMap.Other = _TaskApp2['default'];
...
_React2['default'].render(_React2['default'].createElement(_TaskApp2['default'], null), document.getElementById('tasks'));

},{"./components/BootstrapLayout":158,"./components/SimpleCard":159,"./components/TaskApp":160,"react":157}],2:[function(require,module,exports){
...
var BootstrapLayout = _React2["default"].createClass({
    ...
    renderComponent: function renderComponent(component, index) {
        ...
        return _React2["default"].createElement(comp, { key: index });
    },
...
var TaskApp = _React2['default'].createClass({
    ...
    render: function render() {
        return _React2['default'].createElement(
            ...
            _React2['default'].createElement(_TaskList2['default'], { items: this.state.items }),
            _React2['default'].createElement(
                'form',
...
},{"./TaskList":161,"react":157}],161:[function(require,module,exports){
'use strict';
...
var TaskList = _React2['default'].createClass({
    ...
    render: function render() {
        ...
        var displayTask = function displayTask(task, index) {
            return _React2['default'].createElement(
                'li',
                { key: index },
                task
