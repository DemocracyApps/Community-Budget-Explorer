...
@section('content')
    ...
    @include('government.tabs', ['page'=>'sites'])
    <div class="row">
        <div class="col-xs-12">
            <button style="float:right; position:relative; right:50px; bottom:-10px;" class="btn btn-success btn-sm" onclick="window.location.href='/governments/{!! $organization->id !!}/sites/create'">Add Site</button>
        </div>
    </div>
    <br>
    <div class="row">
...
@section('scripts')
    <?php
    JavaScript::put([
            'ajaxPath' => Util::ajaxPath('governmentAdmin', 'sites'),
    ]);
    ?>
    <script>
        $(function() {
