...
var avb_table = function () {
    ...
    */
    var textRow = function (msg, $table) {
    ...
    */
    var renderNode = function (node, level, container) {
    ...
    */
    var renderSparkline = function (node, cell) {
    ...
    *   @param {jquery object} - current cell
    */
    var renderGrowth = function (data, cell) {
    ...
    *   @param {jquery object} - current cell
    */
    var renderAmount = function (data, cell) {
    ...
    *   @param {jquery object} - current cell
    */
    var renderImpact = function (data, cell) {
    ...
    *   @param {jquery object} - current cell
    */
    var renderMaplink = function(data, cell){
