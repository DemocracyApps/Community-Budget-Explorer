...
var avb_chart = function() {
    ...
    */
    var initialize = function ($container, avb) {
    ...
    */
    var legend = function (avb, layers, parent) {
        ...
        chart.legendLayers.each(function (d) {
            legendLabels.push({
                ...
                percentage: 100 * d.values[avb.yearIndex].val / chart.legendParent.values[avb.yearIndex].val
            });
        });
    ...
    */
    var initializeLayers = function () {
        ...
        if (false) {
            if (utilities.ie() || jQuery.browser.mobile) return;
        }
    ...
    */
    var open = function (data, color, avb) {
        ...
        var yAxis = d3.svg.axis().scale(chart.yscale).ticks(4)
            ...
            .tickFormat(function (d) {
                return utilities.formatcurrency(d);
            });
        ...
        d3.select('.xAxis g:nth-child(' + (avb.yearIndex + 1) + ')')
    ...
    */
    var setDatapointsVisibility = function () {
    ...
    */
    var slideLayers = function (x, avb) {
        ...
        function updateInfo(year) {
            ...
            if (avb.yearIndex === newIndex) return;
            avb.yearIndex = newIndex;
        ...
        if (false) {
            if (!utilities.ie() && !jQuery.browser.mobile) chart.layerLine.attr('x', x - 10);
        }
    ...
    */
    var addActions = function (avb) {
        ...
        function dragMove(e) {
            ...
            slideLayers(touchStart.x + delta.x,avb);
    ...
    *   @param {node} data - node for which data has to be displayed
    */
    var drawLayers = function (data, avb) {
        ...
        if (data.sub.length === 0) {
            ...
            legend(avb, legendData, legendData.datum());
            return;
        }
        ...
        setTimeout(function(){
            slideLayers(chart.layersWidth, avb);
        }, 10);
